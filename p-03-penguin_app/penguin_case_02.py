...
if uploader_file is None:
    # 加载模型
    with open("D:/st_courses/02-Projects/p-03-penguin_app/rfc_model.pickle", "rb") as file:
        model = pickle.load(file)
        st.write("### rfc model : \n", model)
    # 加载标签名称
    with open("D:/st_courses/02-Projects/p-03-penguin_app/label_names.pickle", "rb") as file:
    ...
    st.image("D:/st_courses/02-Projects/p-03-penguin_app/model_feature_importance.png")
